...
public class EditorScreen extends Screen {
    ...
    public static boolean isValidNamespacedId(String s) {
        ...
        if (!ResourceLocation.isValidNamespace(splited[0]) || !ResourceLocation.isValidPath(splited[1])) return false;
        return true;
    }
    ...
    public void renderBackground(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blit(GuiConstants.LEFT_SHEET, bookX - 6, bookY + 45, 0, 0, 122, 167, 122, 167);
    }
