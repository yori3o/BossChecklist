...
public class BossInfoScreen extends Screen {
    ...
    public void init() {
        ...
        if (boss.definition().brokenModel()) {
            BOSS_IMG = new ResourceLocation("boss_checklist", "textures/gui/bosses/" + bossId.replace(":", "_") + ".png");
    ...
    public void renderEntityInGui(GuiGraphics graphics, int x, int y, int scale, float partialTicks) {
        ...
        poseStack.translate(x, y + bossYCorrection, 100); // for 1.20.1 or 1.21.4 change z to 100
