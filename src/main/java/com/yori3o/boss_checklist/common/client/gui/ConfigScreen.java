...
public class ConfigScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.text(font,  "§l" + Component.translatable("gui.boss_checklist.settings").getString(), bookX + 137, bookY + 53, 0xFF000000, false);
        ...
        if (mouseX >= bookX + cbs_client_x && mouseX < bookX + cbs_client_x + 8 && mouseY >= bookY + cb1_y && mouseY < bookY + cb1_y + 8) {
            ...
            guiGraphics.tooltip(
                ...
                List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.progression_mode_desc").getVisualOrderText()
                )),
            ...
            if (mouseX >= bookX + cbs_client_x && mouseX < bookX + cbs_client_x + 8 && mouseY >= bookY + cb2_y && mouseY < bookY + cb2_y + 8) {
                guiGraphics.tooltip(
                    Minecraft.getInstance().font,
                    List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.progression_mode_plus_desc").getVisualOrderText())),
                    mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                );
            } else {
                if (mouseX >= bookX + cbs_client_x && mouseX < bookX + cbs_client_x + 8 && mouseY >= bookY + cb3_y && mouseY < bookY + cb3_y + 8) {
                    guiGraphics.tooltip(
                        Minecraft.getInstance().font,
                        List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.search_bar_enabled_desc").getVisualOrderText())),
                        mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                    );
                } else {
                    if (mouseX >= bookX + cbs_client_x && mouseX < bookX + cbs_client_x + 8 && mouseY >= bookY + cb4_y && mouseY < bookY + cb4_y + 8) {
                        guiGraphics.tooltip(
                            Minecraft.getInstance().font,
                            List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.button_enabled_desc").getVisualOrderText())),
                            mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                        );
                    } 
                }
        ...
        if (IS_LOCAL_SERVER) {
            if (mouseX >= bookX + cbs_server_x && mouseX < bookX + cbs_server_x + 8 && mouseY >= bookY + cb21_y && mouseY < bookY + cb21_y + 8) {
                    guiGraphics.tooltip(
                        Minecraft.getInstance().font,
                        List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.save_boss_killer_desc").getVisualOrderText())),
                        mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                    );
            } else {
                if (mouseX >= bookX + cbs_server_x && mouseX < bookX + cbs_server_x + 8 && mouseY >= bookY + cb22_y && mouseY < bookY + cb22_y + 8) {
                    guiGraphics.tooltip(
                        Minecraft.getInstance().font,
                        List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.enable_statistics_desc").getVisualOrderText())),
                            mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                    );
                } else {
                    if (mouseX >= bookX + cbs_server_x && mouseX < bookX + cbs_server_x + 8 && mouseY >= bookY + cb23_y && mouseY < bookY + cb23_y + 8) {
                        guiGraphics.tooltip(
                            Minecraft.getInstance().font,
                            List.of(ClientTooltipComponent.create(
                         Component.translatable("gui.boss_checklist.settings.enable_async_desc").getVisualOrderText())),
                                mouseX, mouseY, (screenWidth, screenHeight, x, y, tooltipWidth, tooltipHeight) -> new Vector2i(x + 12, y - 2), null
                        );
                    }
                }
