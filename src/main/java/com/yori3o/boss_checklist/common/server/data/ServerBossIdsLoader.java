...
public final class ServerBossIdsLoader {
    ...
    private static final Identifier JSON_RL = Identifier.fromNamespaceAndPath("boss_checklist", "server_bosses_ids.json");
    ...
    public static void load(ResourceManager rm) {
        ...
        try {
            // get all resources with such Identifier from all data packs
        ...
        LoggerUtil.info("Number of registered boss ids on the server: " + LOADED_BOSSES.size());
